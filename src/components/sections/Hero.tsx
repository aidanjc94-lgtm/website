  ...
  return (
    <section className="relative isolate overflow-hidden bg-fenland-warm bg-fenland-radial">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 sm:py-24 lg:grid-cols-[1.08fr_0.92fr] lg:px-8">
        <div>
          <p className="text-sm font-black uppercase tracking-[0.24em] text-fenland-red">Adult running club in Wisbech</p>
          <h1 className="mt-5 text-5xl font-black tracking-tight text-fenland-dark sm:text-7xl lg:text-8xl">
            Friendly running, Fenland energy.
          </h1>
          <p className="mt-6 max-w-2xl text-xl leading-9 text-fenland-dark/75">
            Fenland Running Club helps and encourages adult runners of different abilities, with welcoming club nights, qualified support and a strong community spirit.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <CTAButton href="/join/">Join us</CTAButton>
            <CTAButton href="/training/" variant="outline">View training</CTAButton>
          </div>
        </div>
